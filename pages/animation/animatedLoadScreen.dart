...
Widget wrapItInAnimatedLoadingWidgetOnTopWhichInterceptsTouch(BuildContext context,Widget widget, bool isLoadingNow) {
  return Stack(
    children: [
      IgnorePointer(
        child: widget,
        ...
        child: Center(
            child: Stack(
                children:[
                  Container(
                    height: 105,
                    child: Image.asset("images/newHouseLogiQIcon2.png",
                      fit: BoxFit.contain,
                    ),
                  ),
                  Loader()
...
class Loader extends StatefulWidget {
  ...
  Loader({this.radius = 80.0, this.dotRadius = 12.0});
