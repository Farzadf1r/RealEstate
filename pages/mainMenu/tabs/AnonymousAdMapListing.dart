...
class AnonymousAdMapListing extends StatefulWidget {
  createState() => AnonymousAdMapListingState();
}

class AnonymousAdMapListingState extends State<AnonymousAdMapListing> {
      ...
      Column(
        ...
        children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.end,
              children: [_createListingButton(), _createFilterButton(context),]),
      ...
      //alignment: Alignment.centerRight,
        child: SizedBox(
          ...
          child: IconButton(padding: EdgeInsets.all(2),
            ...
            icon: Icon(Icons.list, color: Colors.blue, size: 25.0,),
