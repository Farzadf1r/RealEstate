...
class CustomerMainMenu extends StatefulWidget {
  createState() => CustomerMainMenuState();
}

class CustomerMainMenuState extends State<CustomerMainMenu>
  ...
  void initState() {
    super.initState();
    controller = TabController(/*initialIndex: 2,*/ length: 4, vsync: this);
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
              icon: Icon(Icons.star, size: 28), label: "Favorites"),
          BottomNavigationBarItem(
              icon: Icon(Icons.home, size: 28), label: "Home"),
          BottomNavigationBarItem(
              icon: Icon(Icons.map, size: 28), label: "Map"),
          BottomNavigationBarItem(
              icon: Icon(Icons.account_circle, size: 28), label: "Your Info"),
        ],
      ),
    );
  }
  ...
  _getTabTitle() {
    switch (controller.index) {
      case 3:
        return halveticaText("Your Info",
            color: Color(0xff5e5e5e), fontSize: 15, weight: FontWeight.bold);
      case 1:
        // return _createHallmarkLogo();
      case 2:
        return _createHallmarkLogo();
      case 0:
        return halveticaText("Favorites",
            color: Color(0xff5e5e5e), fontSize: 13, weight: FontWeight.bold);
    }
  }
}
